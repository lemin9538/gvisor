...
func (e *endpoint) Close() {
	...
	e.disableLocked()
	e.mu.groupAddressableEndpoint.LeaveAllGroups()
	e.removeAllPermanentAddressesLocked()
...
func (e *endpoint) RemoveAllPermanentAddresses() {
	e.mu.Lock()
	defer e.mu.Unlock()
	e.removeAllPermanentAddressesLocked()
}

func (e *endpoint) removeAllPermanentAddressesLocked() {
	e.mu.ndp.removeSLAACAddresses(false /* keepLinkLocal */)
	e.stopDADForAllPermanentAddressesLocked()
	e.mu.addressableEndpoint.RemoveAllPermanentAddresses()
}
...
func (e *endpoint) LeaveAllGroups() {
	e.mu.Lock()
	defer e.mu.Unlock()
	e.mu.groupAddressableEndpoint.LeaveAllGroups()
}
