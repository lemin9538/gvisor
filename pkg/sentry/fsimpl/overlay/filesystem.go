...
func (fs *filesystem) SetStatAt(ctx context.Context, rp *vfs.ResolvingPath, opts vfs.SetStatOptions) error {
	...
	if err := d.setStatLocked(ctx, rp, opts); err != nil {
		fs.renameMuRUnlockAndCheckDrop(ctx, &ds)
		return err
	}
	fs.renameMuRUnlockAndCheckDrop(ctx, &ds)
...
func (fs *filesystem) SetXattrAt(ctx context.Context, rp *vfs.ResolvingPath, opts vfs.SetXattrOptions) error {
	...
	if err := fs.setXattrLocked(ctx, d, rp.Mount(), rp.Credentials(), &opts); err != nil {
		fs.renameMuRUnlockAndCheckDrop(ctx, &ds)
		return err
	}
	fs.renameMuRUnlockAndCheckDrop(ctx, &ds)
...
func (fs *filesystem) RemoveXattrAt(ctx context.Context, rp *vfs.ResolvingPath, name string) error {
	...
	if err := fs.removeXattrLocked(ctx, d, rp.Mount(), rp.Credentials(), name); err != nil {
		fs.renameMuRUnlockAndCheckDrop(ctx, &ds)
		return err
	}
	fs.renameMuRUnlockAndCheckDrop(ctx, &ds)
